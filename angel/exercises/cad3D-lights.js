...
var vertexBufferId, normalBufferId;
...
window.onload = function init() {
  ...
  document.getElementById("modelList").onchange = updateModelMenu;
...
function animateLight(light) {
  ...
  light.position[1] = light.radius * Math.sin(radians(light.angle));
}
